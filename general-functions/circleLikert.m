...
%
% Edited by Kyle Stephens, powcrashwham@gmail.com, 2014
...
circleRater(c,bottomtext,scaletext,colors,c.win,scanner);
...
while true
    if scanner==1
        ...
        key = GetKey({'RightArrow' 'LeftArrow' 'space'},[],[],-3);
